...
export const ReagentsPage: FC = () => {
  ...
  const openDraft = () => {
    ...
    navigate(`${ROUTES.METHANE_APPLICATION}`);
  };
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="tools-panel">
        ...
        <div
            className={`calculate-btn ${
              draftItems.length > 0 ? 'cart-active' : 'cart-disabled'
            }`}
            onClick={openDraft}
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        {imageEmbedding && (
          <Button variant="secondary" size="sm" onClick={resetSearch} style={{ marginLeft: 12 }}>
            Сбросить
          </Button>
        )}
